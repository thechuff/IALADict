...
>
>Aside from correcting typos or misattributed parts of speech, this project aims to make translating into (and learning) more accessible, e.g. **eructation** is not known to the average English speaker, and belching is better; our efforts add 'burp'.  We also add here [proposed] words that make sense to us but have not seen identified usage, as well as words in use (e.g. on [Wikipedia](https://ia.wikipedia.org)) yet not found in the IED (e.g. **bullismo**).
## Sources

IED (Interlingua-English Dictionary)
[Interlingua/Profanity (Wikibooks)](https://en.wikibooks.org/wiki/Interlingua%2FProfanity)
...
**abscesso** *n* abscess
**abscinder [-scind-/-sciss-]** *v* to cut off,
...
**absorbite** 1. *pp* of **absorver**; 2. *adj* absorbed
...
**activate** 1. *pp* of **activar**; 2. *adj* activated
**activation** *n* activation
**active** *adj* active; **le voce active** the active voice; [Colloq.] [Sex] top (usu referring to anal sex)
...
**adelpho**- *n* [occurring in compounds] adelpho-,
**adelph**- (1. brother; 2. twin) *Hence:* monadelphe etc.; Philadelphia etc.
...
**adjudicar** *v* to adjudge (= to award judicially, as a prize, etc.); **adjudicar a** to knock down to (at an auction) *Hence:* adjudication; adjudicative; adjudicator;
adjudicatario
...
**adriatic** *adj* Adriatic (1. pertaining to the city of adria; 2. pertaining to the Adriatic); **Mar Adriatic** Adriatic Sea
...
**adversitate** *n* adversity [adverso] adv/prep 1. towards; 2. against; 3. opposite
**advertente** 1. *ppr* of **adverter**; 2. *adj* advertent, attentive
**advertentia** *n* advertence, advertency
**adverter [-vert-/-vers-]** *v* to advert, have reference (to) *Hence:* advertente-advertentia, inadvertente- inadvertentia; adverse-adversario, adversitate;
adversar-adversative; animadverter etc.
...
**agglutinar** *v* to stick or glue together,
**agglutinate** *Hence:* aglutinante; agglutination; agglutinative
...
-**agog**- *adj* [occurring in compounds] -agogue (1. leading; 2. drawing forth) *Hence:* sialagoge etc.; hypnagogic etc.; demagogo etc.; pedagogo etc.
...
**al**- *prefix* [occurring in derivatives and compounds] *Hence:* alimento &; alibile &; coal- & -al- [occurring in compounds] *Hence:* nyctalopia etc.
**ala** *n* wing (1. "wing of a bird, airplane etc."; 2. part of a building) *Hence:* aletta; **alate à la** [F] à la (as in "à la Newburgh")
**alabastrin** *adj* alabastrine, alabaster
**alabastrite** *n* alabaster (= Oriental alabaster)
**alabastro** *n* alabaster (as in "gypseous alabaster") *Hence:* alabastrite; alabastrin à la carte [F] à la carte
...
**albumin·uria** *n* [Pathol.] albuminuria [al(c)-] [occurring in compounds] some-, any- (= ali(c)-) *Hence:* alco; alcun etc.; alcuno etc.; alquando etc.
**alca** *n* [Ornith.] auk
**alcal**- *see* **alcali**
...
**allegorisation** *n* allegorization
...
**alsatiano** *n* Alsatian [alsi] (-í) *adv* 1. also, too; 2. likewise, moreover, furthermore
...
**amalgama (-mál-)** *n* amalgam *Hence:* amalgamar-amalgamation, amalgamator
...
**amante** *adj* [Colloq.] [Sex] top (usu referring to anal sex)
...
**analyse (-ályse)** *n* analysis; **analyse qualitative** qualitative analysis;
**analyse quantitative** quantitative analysis; **analyse infinitesimal** infinitesimal calculus; **in le ultime analyse** in the last analysis, all things considered *Hence:* analysar-analysabile, analysator, analysta; psychoanalyse etc.
...
**anarch**- *adj* [occurring in derivatives and compounds] anarch-, anarcho- (= anarchic, anarchical) *Hence:* anarchia-anarchismo, anarchista,
anarchic; anarchosyndicalismo etc.; anarchosyndicalista etc.
...
**ancora (án-)** *n* anchor *Hence:* ancorar-ancorage; disancorar [ancora] 1. *adv* still, yet; 2. *interj* encore!
...
**anglo·phobe (-ó-)** *adj* Anglophobe,
**anglophobic** *Hence:* anglophobia; anglophobo
**anglophobia (-ía)** *n* Anglophobia
**anglophobo (-óphoho)** *n* Anglophobe
**anglos** *npl* [Hist.] Angles *Hence:* Anglia; anglese; anglic-anglicismo,
anglican-anglicanismo, anglicano, anglicisar; angloamerican etc; anglocatholic etc.; anglosaxone etc.; anglophile etc.; Anglaterra etc. 
...
**anilingus** or **anilinction** *n* [Colloq.] [Sex] rimming, eating ass, anilingus
...
**annunciation** *n* announcement; le
**annunciation** the Annunciation
**annunciator** *n* announcer
**annuncio** *n* 1. announcement; 2. advertisement
**ano** *n* [Anat.] anus *Hence:* anal; anello &; anulo & -ano suffixo substantive [used with names of places and persons] 
-**an** (1. native, citizen, or inhabitant of ...; 2. language of ...; 3. adherent of ...) *Hence:* africano etc.; italiano etc.; mohammedano etc.
...
-**ante** *suffixo adjective* [used with verbs in -ar; forming verbal adjectives] -ing, 
-**ant** (as in "abounding," "abundant") *Hence:* -antia; abundante etc.; brillante etc. 
...
**antialcoholista** *n* antialcoholist
...
**ape** *n* bee; **ape operari, ape neutre** working bee; **ape matre, ape regina, ape femine** queen bee; **ape mascule** drone *Hence:* apiario¹; apiario², apicula-apiculario; apicultura etc.; apivore etc. [a·pena] *adv* hardly, scarcely (= a pena)
...
**apo**- *prefixo* [ap- before -h- and vowels; used chiefly to form technical terms] apo-, ap- (1. off,
away; 2. separate) *Hence:* apogee etc.: apostasia etc.
...
appest**a**r *v* to infect (with a plague)
...
**approbar** *v* to approve, approve of *Hence:* approbabile; approbation; approbative;
approbator; approbatori; disapprobar- disapprobation, disapprobator
...
-**ar** *suffixo verbal* [used with nouns and adjectives] -ate or zero (as in "to catenate; to chain, etc.") (1. [with nouns] to make use of ..., to apply ..., etc.; 2. [with adjectives] to render ..., to + '. ., etc.) *Hence:* martellar etc.; acierar etc.; examinar etc.; vulnerar etc.; siccar etc.; duplicar etc.
...
**argento** *n* silver; **argento vive** quicksilver, mercury *Hence:* argentano; argentero; argenteria;
argentee; argentifere; argentin-argentino, argentina, Argentina; argentose; argentar-argentator, argentate, disargentar
...
**ariete** *n* 1. ram; 2. battering ram; *also:* [Rom. antiq.] Aries; **ariete hydraulic** hydraulic ram;
**ariete** [Astron.] Aries, Ram *Hence:* arietari; arietar-arietation
...
**arma** *n* arm (1. weapon; 2. branch of the military service); **armas blanc** side-arms;
**armas de foco** fire-arms; **homine de armas** man-at-arms; **prender le armas** to take up arms; armas [Her.] arms; [proposed] **controlo de armas** arms control, non-proliferation; *Hence:* armero; armar-armamento, armatura, armea, disarmar-disarmamento, rearmar- rearmamento; armistitio etc.; armipotente etc.
...
**armate** 1. *pp* of **armar**; 2. *adj* armed
...
**arte** *n* art (1. "fine art"; 2. skill); **opera de arte** work of art; **artes liberal** liberal arts; **belle artes** fine arts; [proposed] **artes scenic** performing arts *Hence:* artisano; artista-artistic; artifice etc.; artefacto etc.
...
**articulo** *n* I. [Anat.] joint; II. article (1. paragraph, section; 2. "article in a magazine, newspaper, etc.); 3. "article of merchandise"; 4. [Gram]); **articulo de fide** article of faith;
**articulo de fundo** editorial, leading article; **articulo definite (indefinite)** definite (indefinite) article *Hence:* articulista; articular¹; articular²-articulabile-inarticulabile, articulation,
articulate-inarticulate, multiarticulate etc., multarticulate etc.; disarticular-disarticulation
...
**ascender [-scend-/-scens-]** *v* to ascend *Hence:* ascendente-ascendentia; ascension-
ascensional, ascensionista; ascensor
**ascens**- *see* **ascender**
...
**ascoltabile** _adj_ worth listening to  
...
**assignation** *n* assignation, assignment (1. act of
allotting; 2. [Law] transfer of property, a right, etc.)
...
**assyrio·logo (-ólogo)** *n* Assyriologist,
**assyriologue** *Hence:* assyriologia
...
**astringer [-string-/-strict-]** *v* to astringe *Hence:* astringente-astringentia; astriction;
astrictive
**astro** *n* star (1. heavenly body; 2. starshaped figure, etc.) *Hence:* astral; disastro &; astrophotographia etc.; astrolatria etc.; astrophysic etc.; astronomo etc.; astrolabio etc. -astro suffixo substantive [used with nouns] 1. -aster (= inferior or worthless ...); 2. step- (as in "stepfather") *Hence:* -astra; poetastro etc.; patrastro etc.
...
**atele (-té-)** *n* spider monkey; Ateles -atelia (-ía) *n* [occurring in compounds] *Hence:* philatelia etc.
...
**atonia (-ía)** *n* atony (1. [Med.]; 2. [Phonet.])
...
-**atoria** *suffixo substantive* [used with verbs in -ar] -er (= instrument for ...ing) *Hence:* mangiatoria etc. 
...
**atr**- *adj* [occurring in derivatives and compounds] atro- (= black) *Hence:* atrabile etc. ... -**atra** *see* -**latra**
...
**auro** *n* gold; **folio de auro** gold foil or leaf; **natar in le auro** to be rolling in wealth;
**auro virgine** virgin or native gold; **pagar in auro** to pay in gold; **de auro** golden, gold (= made of gold); **etate de auro** golden age *Hence:* auree; aurifere; aurar-aurate, disaurar;
aurifice-aurificar-aurification; auripigmento etc.; auriforme etc.
...
**baniator** *n* bather
**banio** *n* bath (1. act of giving or taking a bath; 2. bath water); **banios** baths (= hot or mineral springs); **camera de banio** bathroom *cf* **W.C.** *Hence:* baniar-baniator; banio-maria etc.
...
**battente** 1. *ppr* of **batter**; 2. *adj* beating
...
**biblioteconomia** [proposed] *n* library science, library studies  
...
**billionesimo (-né)** *n* billionth (part)
...
**bizarria (-ía)** *n* strangeness, oddness, oddity
**bi·zonal** *adj* bizonal
blanc *adj* white, blank; **papiro blanc** blank paper; **carta blanc** carte blanche; **verso blanc** blank verse *Hence:* blanchir-blanchimento; blanco
**blanch**- *see* **blanc**
**blanchimento** *n* 1. (act of) whitening,
**blanching**; 2. [Metal.] (act of) blanching; 3. (act of) bleaching
...
**bolla** *n* ball, globe; **joco de bollas** game of bowls, bowling; **jocar al bollas** to play bowls, to bowl *Hence:* bolletta; bollar
**bollar** *v* to bowl
...
**bravada** *n* bravado
**bravar** *v* to brave
**brave** *adj* 1. brave, courageous; 2. excellent, fine *Hence:* bravura; bravar-bravada; bravo-braveria
...
**brillante²** *n* brilliant (= diamond cut to sparkle brightly)
...
**bronchos** [Anat.] bronchi *Hence:* bronchio &; bronchopneumonia etc; bronchotomia etc.; bronchotomo etc.; bronchoscopio etc.
...
**cacar** *v* [Colloq.] to poo, to poop, to shit, to crap, to take a dump, to defecate **cacar se** to shit os, to soil os
...
**caduc** *adj* falling; caducous
**camera** 🚧 **camera corporal** body camera, bodycam, body-worn camera  
**cannabis** *n* cannabis, marijuana
**caralio** *n* [Colloq.] dick, cock, pecker, penis
**catalogation** [proposed] *n* cataloging (as in a library)  
**cauda** *n* [Colloq.] (not vulgar, but informal) dick, cock, pecker, penis
**cerate** 1. *pp* of **cerar**; 2. *adj* waxed
**chlorhydric** *adj* hydrochloric
**cinquantesimo (-té-)** *n* fiftieth (part)
**circulante** 1. *ppr* of **circular**; 2. *adj* circulating
**cocte** 1. *ppr* of **cocer**; 2. *adj* baked
**colion (-ón)** *n* [Colloq.] (vulgar) testicle, ball **haber le coliones** to have the balls (to do); to have balls
**comic** _n_ comic, comic strip, comic book **comics** comics [proposed]
**commandita** *n* [Com. Law] limited partnership, LP
**comprimite** 1. *pp* of **comprimer**; II. *adj* 1. compressed; 2. repressed, restrained
**considerante** *prep* considering
**conspiration** *n* 🚧 **theorias del conspiration** conspiracy theories
**contraplicate** *adj* laminated
...
**cornute** *adj* [Colloq.] cuckolded, cuckold (adj)
**cornuto** *n* [Colloq.] (masc) 1. cuckold; 2. asshole
**coronate** 1. *pp* of **coronar**; 2. *adj* crowned
**costate** 1. *pp* of **costar**; 2. *adj* costate, ribbed
**crepa** *phr* **crepa!** [Colloq.] fuck you; go die, kill yourself **va crepar!** fuck you; go die, kill yourself
**cretin (-ín)** *adj* [Colloq.] idiot, moron, dumbass, cretin
**cretina** *n* [Colloq.] (fem) idiot, moron, dumbass, cretin, bimbo
**cretino** *n* [Colloq.] (masc) idiot, moron, dumbass, cretin
**crimine** 🚧 [proposed] **crimine de guerra** war crime
**cruciate** 1. *pp* of **cruciar**; II. *adj* 1. intersecting; 2. crossbred
**cucu (-cú)** *n* 1. [Colloq.] 2. cuckold; dumbass, idiot, easily fooled person
**culetto** *n* [Colloq.] (children's language, or showing attractiveness) little butt, booty, (little) bum **un belle culetto** a hot booty, a sexy ass
**culo** *n* [Colloq.] butt, ass, arse, buttocks, rump, bum
**culminante** 1. *ppr* of **culminar**; 2. *adj* culminant, culminating
**cunnilingus (cunnilinction)** *n* [Colloq.] cunnilingus, eating out, eating pussy, muff-diving, pussy licking, going down (on a female)
**cunno** *n*, [Colloq.] cunt
**cyber-** _prfx_ [used in compounds]  
**cyberattacco** _n_ cyberattack  
**cyberbullismo** _n_ cyberbullying, online bullying  
**cybercafé** _n_ cybercafe, Internet cafe  
**cybercrimine** _n_ cybercrime  
**cybernetica** _n_ cybernetics  
**cyberpagina** _n_ webpage  
**cyberpunk** _n_ cyberpunk (style) _adj_ cyberpunk  
**cybersecuritate** _n_ cybersecurity  
**cybersito** _n_ Website  
**cybersquatting** _n_ cybersquatting

---
### D
**da capo**, [I] [Mus.] da capo (D.C.) (= from the beginning)
**dactylic** *adj* dactylic
**dactylo (dác-)** *n* 1. date (= fruit of the date palm); 2. [Pros.] dactyl *Hence:* dactylic; dactylographo etc.; dactyloscopia etc.; tetradactyle etc.; pterodactylo etc.
**dactylographar** *n* to typewrite, to type
**dactylographia (-ía)** *n* typewriting, typing
**dactylographic** *adj* (pertaining to a) typewriter
**dactylo·grapho (-ó)** *n* 1. typewriter (= typing machine); 2. typist *Hence:* dactylographia; dactylographic; dactylographar
**dactylo·logia (-ía)** *n* dactylology, finger spelling
...
**daltonian** *adj* Daltonian; *also:* colorblind
**daltonismo** *n* Daltonism; *also:* colorblindness
...
**damasceno** *n* 1. Damascene (= inhabitant of Damascus); 2. damson (*Prunus insititi*)
**Damasceno** *npr* Damascus; damasco damask (= damask silk) *Hence:* damascen-damascenar-damascenage, damascenator, damasceno; damascar
...
**damnificar** *v* to damage, to damnify
**damno** *n* harm, damage; injury, loss *Hence:* damnose-damnositate; damnar &; damnificar; indemne &
**damnose** *adj* harmful, injurious, damaging
**damnositate** *n* harmfulness, injuriousness
**dan** *adj* Danish *Hence:* dano-danese; Danmark etc.
**danese** *adj* Danish
**danese** *n* 1. Danish (language); 2. Dane (= native of Denmark); 3. (great) Dane (dog)
**Daniel** *nprm* Daniel
**Dan-mark** *npr* Denmark
**dano** *n* 1. Dane (= native of Denmark); 2. (great) Dane (dog)
...
**dar** *v* 1. to give; **dar super** to overlook (as in "the window overlooks the garden"); 2. [Colloq.] [Sex] to be a top (usu referring to anal sex) **illa/ille qui lo da** top, s/he who gives [the penis] *Hence:* dative-dativo; dator; dato; data &; adder &; eder &; perder &; render &
...
**darsena (dár-)** *n* Dardanian, Trojan
...
**David** *nprm* David
**de** *prep* 1. from; since 2. of (belonging of or pertaining to); 3. made of; 4. with, by means of; **de** (+inf) to; for **de nove, de nocte, pensar de**, etc. cf. **nove, nocte, pensar**, etc. *Hence:* [deinde] etc. **-de-** [occurring in compounds] **-de-** (= to divide) *Hence:* geodesia etc.; geodetic etc.
**dea** *n* goddess
**dead heat [A]** *n* [Horse Racing] dead heat
**deambular** *v* to ambulate; to walk around, to stroll about, saunter
**deambulation** *n* deambulation, stroll, walking around
**deambulatori** *adj* deambulatory, strolling, sauntering
**debatter** *v* to debate **debatter se** to struggle *Hence:* debatto; debattibile
**debattibile** *adj* debatable
**debatto** *n* debate
**deber** *v* 1. to have to, be supposed to, etc. (must, shall, ought); 2. to owe
**deber** *n* 1. duty (= obligation); 2. [School] assignment
**debile** *adj* weak, feeble, debile *Hence:* debilitate-debilitar-debilitation
**debilitar** *v* to debilitate, to weaken, to enfeeble
**debilitate** *n* debility
**debilitation** *n* debilitation, weakening, enfeeblement
**debita (dé-)** *n* debt; **debita de honor** debt of honor; **debita flottante** floating debt
**debitemente** *adv* duly, properly
**debito (dé-)** *n* 1. debit; 2. due (= that which is due legally or morally, as in "give him his due")
**debitor** *n* debtor
**début (F)** *n* (= first public appearance of an actor, singer, etc.)
**débutant (F)** *n* debutant
**débutante (F)** *n* (fem) debutant
**debutar** *v* to make one's debut, to debut
...
**decade (dé-)** *n* decade (1. period of ten days; 2. division of a book consisting of ten parts); 3. [Relig.] a ten-bead portion of a Catholic rosary
**decadente** *adj* decadent
**decadentia** *n* decadence
**decader** *v* to decline, to decay, to become decadent *Hence:* decadente-decadentia
...
**decapitar** *v* to behead, to decapitate *Hence:* decapitation *see* **decollar**
**decapitation** *n* beheading, decapitation *see* **decollation**
...
**dece** *adj* ten *Hence:* decime &; decennio etc.; dece-cinque etc.; duodeco etc.; dece-prime etc.; decigrammar etc.; decemviro etc.; decuple etc.; decuplicar etc.
**dece-cinque** *adj* fifteen
**dece-nono** *n* nineteenth (part)
**dece-primo** *n* eleventh (part)
**dece-secundo** *n* twelfth (part)
**dece-septimo (-sépt-)** *n* seventeenth (part)
**decimo (dé-)** *n* tenth (part)
**deceder [-ced-/-cess-]** *v* 1. to depart, to withdraw; 2. to die, to decease, to pass away *Hence:* decesso; predecessor
...
**dec·ennio** *n* decade (= period of ten years) **dece-non-** *see* dece-nove
...
**deciper [-cip/-cept-]** *v* to deceive (= to cause to believe the false, or disbelieve the truth), to trick, to hornswoggle *Hence*: deception; deceptor
**decis-** *see* **decider**
...
**declamatori** *adj* declamatory (= or pertaining to rhetorical declaiming)
**declarar** *v* to declare (1. to proclaim; 2. (customs) "to<br>declare dutiable goods"); 3. to break out **(un epidemia,<br>revolution, etc.)** **se declarava** (an epidemic, a<br>revolution, etc.) broke out *Hence:* declaration; declarative; declaratori
**declaration** *n* declaration (= formal announcement, strong statement)
**declarative** *adj* declarative
**decerner [-cern-/-cret-]** *v* to decree, to order (formally, as in a decree) *Hence:* decretori; decreto-decretal-decretalista, decretar
**declaratori** *adj* [Law] declaratory
**declinabile** *adj* declinable (1. rejectable; 2. [Gram.])
**declinar** *v* I. to decline (1. to fall, sink; 2. to refuse, reject; 3. [Gram.]); II. [Astron., Magnet.] to deviate (1. to have declination or latitude; 2. to vary from the true magnetic meridian) _Hence_: declino; declinabile-indeclinabile; declination; declinator; declinatori; declinometro etc.
...
**declinator**, _n_ decliner (= one who declines, rejects), rejecter
**declinatori** *adj* declinatory
**declino** *n* decline; *also*: sinking, wane
**declino·metro (-ó-)** *n* declinometer
**decocer [-coc-/-coct-]** *v* to decoct, to boil down, to concentrate (flavor, by boiling) *Hence*: decoction
**decoct-** *see* **decocer**
**decoction** *n* decoction (= action of decocting)
**decollar** *v* to behead, decollate *Hence*: decollation *see* **decapitar**
**decollation** *n* beheading, decollation *see* **decapitation**
...
**decorose** *adj* decorous, appropriate (= in keeping with propriety)
...
**decrescer** *v* to decrease, to fall (in level or amount); **le riviera decresce** the river is falling, going down *Hence*: decrescimento; decrescentia
...
**dedicar** *v* to dedicate (1. to set apart for a sacred or solemn purpose; 2. to inscribe, address as a mark of gratitude, esteem, etc.); **dedicar se a** to dedicate or devote os to *Hence*: dedication; dedicatori
...
**defect-** *see* **defic-**
**defectibile** *adj* defectible, flawed
...
**deficiente** *adj* deficient, lacking
**deficientia** *n* deficiency (= quality of being deficient), lack, shortfall
**deficit (dé-)** *n* deficit *Hence*: deficitari
**deficitari** *adj* showing a deficit
**defilar** *v* [Mil.] to defile (march off in a line), file off *not* **profanar**
...
**degustation** *n* (the act of) tasting (of wines, tea, etc.)
...
**deler [del-/delete-]** *v* 1. to destroy; 2. to delete *Hence*: delibile-indelibile-indelibilitate; deletion
**delet-** *see* **deler**
...
**deltoidee (-ée)** *adj* deltoid (= pertaining to the<br>deltoid muscle)
...
**demandator** *n* demandant, plaintiff, [Law] complainant
...
**demone** *n* 1. [Gr. Relig.] daemon; 2. demon (= evil spirit) *Hence*: demonio-demoniac; demonolatra etc.; demonologia etc.: cacodemone etc.; eudemon- etc.; pandemonio etc. *cf* **demonio**
**demoniac (-í-)** *adj* demoniac, demoniacal (1. pertaining to an evil spirit or evil spirits; 2. possessed by an evil spirit)
**demonio** *n* demon, evil spirit *cf* **demone** 
...
**denigrar** *v* to defame, denigrate Hence: denigration; denigrator<br>**denigration** *n* defamation, denigration<br>**denigrator** *n* slanderer, denigrator<br>**Denis** [F] *nprm* Denis, Dennis<br>**denominar** *v* to name, designate, denominate Hence: denomination; denominative; denominator<br>**denomination** *n* denomination (= characteristic name given to a thing or class of things)<br>**denominative** *adj* denominative (= conferring a denomination or name)<br>**denominator** *n* denominator (1. person or thing that names; 2. [Math.])<br>**denotar** *v* to denote (= to signify by a visible sign), *Hence:* denotation; denotative
...
**denunciar** *v* 1. to proclaim, publish solemnly; 2. to denounce, inform against; **denunciar un**
**tractato** to denounce a treaty *Hence*: denunciation; denunciative; denunciator
...
**deposito (-pó-)** *n* I. deposition (= depositing for safekeeping); II. deposit (1. thing deposited for safekeeping; 2. depository, depot, dump, cache; 3. sediment); **in deposito** in trust; **deposito de munition** ammunition dump *Hence*: depositario; depositar
...
**deputation** *n* I. deputation, deputization (1. appointment as a deputy; 2. group of deputies); II. deputyship 
**deputato** *n* deputy 
**-der** *see* **dar**
...
**derogar** *v* to derogate (from), to depart (from); to waive; **derogar al lege** to depart from the law; **derogar a un principio** to waive a principle; **derogar a su dignitate** to derogate from one's dignity *Hence*: derogation; derogatori
...
**deserte** *adj* desert (as in "desert region") *cf* **desertic**
**desertic** *adj* desert (as in "desert region") *cf* **deserte**
...
**desiderar** *v* to desire, wish, wish for; **lassar (multo) a desiderar** to leave (much) to be desired, leave room for improvement *Hence:* desiderose; desiderio; desiderabile-indesiderabile; desiderative *cf* **desirar**
...
**desirar** *v* to desire, wish, wish for; **lassar (multo) a desirar** to leave (much) to be desired, leave room for improvement *Hence:* desiro-desirose; desirabile-indesirabile *cf* **desiderar**
...
**destinate** 1. *pp* of **destinar**; 2. *adj* destined, fated
**destination** *n* destination (1. action of destining; 2. place of destination)
**destino** *n* destiny (= one's lot or fortune)
**destituer [-stitu-/-stitut-]** *v* 1. to render destitute; to deprive 2. to displace, discharge, dismiss (from office) *Hence:* destitution; destitute
...
**destruer [-stru-/-struct-]** *v* to destroy *Hence:* destructibile-destructibilitate,
indestructibile-indestructibilitate; destruction; destructive; destructor 
...
**deteriorar** *v* to impair (= to cause to deteriorate); **deteriorar se** to deteriorate (intr.), to break down, to fall apart *Hence:* deterioration
...
**detrimento** *n* detriment; **al detrimento de** to the detriment of, at the expense of
**detrimentose** *adj* detrimental
**detrit-** *see* **deter-**
**detrito** *n* detritus, dross
...
**dextero·mane, dextro·mane** *adj* righthanded (= using the right hand more easily
and readily than the left)
**[dextra]** *prep* on the right of
**dextrina** *n* dextrin
**dextro·gyr** *adj* dextrogyrous
**di-** [occurring in compounds] di- (= twice) *Hence*: digamma etc.; dilemma etc.; dimetro etc.; dimorphe etc.; diphthonge etc. **di-** *see also* **dia-**; Zeus
**dia-** *prefixo* [di- before vowels, used chiefly to form technical terms] 
**dia-, di-** (1. through; 2. away, apart) *Hence*: diametro etc.; diastase etc.; diapositiva etc.; diacaustic etc.; diagno- etc.; diorama etc.
...
**digression** *n* digression (1. deviation from the subject in discourse or writing; 2. [Astron.]); **perder se in un digression**/**in digressiones** to lose os in a digression/in digressions
...
**diminuite** 1. *pp* of **diminuer**; 2. *adj* reduced, diminished, lessened
...
**disobedir** *v* to disobey; **disobedir a (un persona)** to disobey (sb)
...
**distinguer [-stingu-/-stinct-]** *v* to distinguish; distinguer se to distinguish os *Hence:* distinguibile-indistinguibile; distinction-indistinction; distinctive; distincte &; distinguitor; distinguite
...
**ebullition** *n* ebullition, boiling; puncto de
...
**ecclesio·logia (-ía)** *n* ecclesiology -ech- [occurring in compounds] *Hence:* entelechia etc. ...
...
**economia (-ía)** *n* economy (1. management of the expenditures of a social group; 2. careful management, thrift); **economias** economies, savings; **economia politic** political economy,
economics; **economia de tempore** saving of time
**economic** *adj* 1. economic; 2. economical
**economisar** *v* to economize
**economista** *n* economist (= student of political economy)
**eco·nomo (-có-)** *n* steward, housekeeper *Hence:* economato; economia-economic;
economista; economisar 
-**ecr**- *see* **sacre**
...
**ecumenic** *adj* ecumenical; **concilio ecumenic** ecumenical council
...
**educate** 1. *pp* of **educar**; 2. *adj* educated
...
**embryon** *n* embryo; **in embryon** in embryo *Hence:* embryonal; embryonari; embryonic;
embryologo etc.; embryogenese etc.; embryogenetic etc.
...
**emolliente** *adj* emollient, softening 
**emolliente** *n* emollient, softener
...
**emulger [-mulg-/-muls-]** *v* to milk dry *Hence:* emulgente; emulsion-emulsionar-
emulsionabile; emulsive; emulsor; emulsina
**emuls**- *see* emulge**r**
...
**enzyma** *n* enzyme [eo] *adv* 1. there; thither; 2. until, up to the time; 3. to that purpose, to that end; 4. therefore; 5. to that degree or extent
...
**ephemero (-fé-)** *n* [Zool.] ephemeron, ephemerid; ephemeros [Zool.] Ephemera,
ephemerida
...
**epigono (-pí-)** *n* epigone (= one of a succeeding and less distinguished generation);
...
**epilogar** *v* to epilogize, to speak an epilogue to, to utter as an epilogue
...
**episcopal** *adj* episcopal; **ecclesia episcopal** episcopal Church episcopal *n* [Theol.]
episcopalian
...
**epistola (-pís-)** *n* 1. letter, epistle; 2. [Eccl.]
**epistle** *Hence:* epistolari; epistolero; epistolographo etc.
...
**eque** *adj* equitable; fair, right *Hence:* equitate; equal &; equar &; inique &; equilatere etc.; equivoc etc.; equidistante etc.; equinoctio etc.; equivaler etc. -equer *see* sequer
...
**equilibrate** 1. *pp* of **equilibrar**; 2. *adj* balanced
**equi·libre** *adj* balanced, in equilibrium *Hence:* equilibrio; equilibrar-equilibrista-
equilibristic, disequilibrar-disequilibrate
...
**equi·noctio** *n* equinox; **precession del equinoctios** precession of the equinoxes *Hence:* equinoctial
...
**era** *n* era; **(le) era christian** (the) Christian Era, A.D. [era] *past* of **esser** was, were
...
-**ero** *suffixo substantive* [used with nouns] -er, -eer, -man (= one who works with or deals in ... or ...s) *Hence:* -eria; branchero etc.; barbero etc.; ferrero etc; joielero etc.; speciero etc.
...
**eructar** *v* to belch, to burp; *also:* to vomit forth *Hence:* eructation
**eructation** *n* belching, burping, eructation
...
**espaventar** *v* to frighten (= to fill with fright); **espaventar se** to become frightened *Hence:* espavento; espaventabile; espaventaaves
etc.
**espavento** *n* fright
...
-**essa¹** *suffixo substantive* [used with nouns] -ess (= female ..., wife of a ...) *Hence:* abbatessa etc.; contessa etc.; duchessa etc.; tigressa etc. -essa² suffixo substantive [used with adjectives] -ess, -ness (= state or quality of being . . ) *Hence:* delicatessa etc.; politessa etc.; prodessa etc.; ricchessa etc.
...
**essayo (-sá-)** *n* 1. trial, test; 2. assay (= assayal); 3. attempt, essay; 4. essay ("literary
essay") *Hence:* essayista; essayar-essayage, essayabile,
**essayator** [esse] *dem* *adj* this, that, these, those *Hence:* esso
...
**esthesia (-ía)** *n* esthesia *Hence:* anesthesia-anesthesiar; esthesiologia
etc.; cinesthesia etc.; pseudesthesia etc.
...
**etate** *n* age (1. lapse of time; 2. period in life); **que etate habe vos?** how old are you?; **etate de auro** golden age *Hence:* coetanee -etate *see* -**itate**
...
**ethn**- *n* [occurring in derivatives and compounds] *Hence:* ethnic; ethnographo etc.;
ethnopsychologia etc.
...
**etiam (é-)** *adv* also, likewise, too; even, even yet; yet; non solmente ... sed etiam ... not only ... but also ...
...
**evangelo (-áng-)** *n* evangelist, evangel *Hence:* Evangelina; evangelio; evangelic;
evangelisar-evangelismo, evangelista, evangelisation, evangelisator
...
**evelia** *n* awakening
**eveliar** *v* to wake (sb, sth) up (= to arouse from sleep); **eveliar se** to wake up (= to come out of sleep) *Hence:* evelia; eveliator
...
**exaltar** *v* to exalt (1. to raise in rank, honor, power, etc.; 2. to extol); **exaltar se** to grow
excited, grow enthusiastic *Hence:* exaltation; exaltate
**exaltate** *adj* overexcited
**exaltation** *n* exaltation (1. act of raising to a superior rank or position; 2. act of praising,
extoling; 3. overexcitement, rapture, etc.
...
**excitar** *v* to excite; [Colloq.] to turn (sb) on **excitar se** to get turned on, to be turned on; *Hence:* excitamento; excitante; excitabile- excitabilitate, inexcitabile; excitation; excitative; excitator; superexcitar-superexcitation
**excitation** *n* I. excitation (1. action of exciting; 2. [Elec.]); II. excitement (= state of being
excited)
...
**exequer [-equ-/-ecut-]** *v* to execute, carry out *Hence:* exequias; execution-electrocution etc.; executive; executor; executori: executar-executabile-inexecutabile, electrocutar etc.
...
**exo·game (-ógame)** *adj* [Anthropol.]
**exogamous** *Hence:* exogamia
...
**experimental** *adj* experimental; **scientia experimental** experimental science
...
**expulicar** *v* to clean of fleas, to de-flea, to delouse
...
**extinguer [-stingu-/-stinct-]** *v* to extinguish; **extinguer un debita** to extinguish or pay off a debt *Hence:* extinguibile-inextinguibile; extinction; extinctive; extinctor; extinct 
...
**extraterrestre** _n_ extraterrestrial, alien
...
**fardar** *v* to paint, make up; **fardar se** to make up, paint os
...
**feldspat** *n* feldspar
**felice** *adj* happy, fortunate *Hence:* felicitate-felicitar &; infelice-infelicitate **Felice Natal** Merry Christmas **Felice Pascha** Happy Easter **Felice Anniversario** Happy Birthday
...
**festar** *v* 1. to celebrate, keep (a festival or feast day); 2. to feast, regale os; 3. to fete, honor (by festive observances)
**festear** *v* to feast (= to entertain lavishly)
**festinar** *v* 1. to feast, regale os; 2. to fete (= to honor by festive observances)
...
**[for]** I. *adv* 1. out of doors, outside, out; 2. from without; II. *prep* 1. beyond; 2. except; **for de** outside of, without; **for de se** beside os (= foras, foris)
**for-** *see* **foras, foris**
...
**foras, foris (fór-)** I. *adv* 1. out of doors, outside, out; 2. from without; II. *prep* 1. beyond; 3. except; **foras de** outside of, without; **foras de se** beside os *Hence:* forcipe etc.
...
**fortiate** 1. *pp* of **fortiar**; 2. *adj* forced, compulsory
...
**fortissime** *adj* 1. very strong; 2. [Mus.] fortissimo, very loud
...
**fumate** 1. *pp* of **fumar**; II. *adj* 1. smoked; 2. [Cooking] smoked, cured; 3. fumed, angry
...
**fundite** 1. *pp* of **funder**; 2. *adj* melted, liquified; *also*: [Metal.] fused
...
---
### G
**galopante** 1. *ppr* of **galopar**; 2. *adj* galloping
**gehenna** *n* Gehenna, Hinnom
**georgian** _n_ Georgian (language)
**gordian** *adj* Gordian
...
**hachate (-sh)** 1. *pp* of **hacher**; 2. *adj* chopped
...
**hallelujah (-úya)** *interj* hallelujah, alleluia
**hallo!** *interj* hello!
...
**helium (hé-)** *n* [Chem.] helium; helio- [occurring in derivatives and compounds] heli-,
**helio**- (= sun) *Hence:* heliac; ephelide; heliantho etc.; heliotypo etc.; heliocentric etc.; heliotrope etc.
**hell**- *see* **Hellen**
...
**hem- [-ma/-mat-]** *n* [occurring in derivatives and compounds] hem-, hemo-, hemat-, hemato- (= blood) *Hence:* hematite; hematic; hematosis; anemia &;
hemoglobina etc.; hemophile etc.; hemorrhagia etc.; hemorrhoide etc.; hemostato etc.; hemostatic etc.; leucemia etc.; septicemia etc.; uremia etc.
**hemat**- *see* **hem**-
...
**hemi·prisma** [-ma/-mat-] *n* [Cryst.]
**hemiprism** *Hence:* hemiprismatic
...
**hemi·trope (-í-)** *adj* [Cryst.] hemitrope,
**hemitropic** *Hence:* hemitropia
...
**herpetic** *adj* herpetic; **eruption herpetic** herpetic eruption, flare-up (of HSV)
...
**hexa·metre (-ámetre)** *adj* hexameter,
**hexametric** *Hence:* hexametro
**hexametro (-ámetro)** *n* hexameter
**hexapode (-ápode)** *adj* hexapod *Hence:* hexapodo
**hexapodo (-ápodo)** *n* hexapod
**hiar** *v* 1. to stand open, gape, yawn; 2. to leave a
**hiatus** *Hence:* hiato
**hiato** *n* hiatus (1. lacuna; 2. [Gram., Pros.]) -hib- *v* [occurring in compounds] *Hence:* exhibir &; inhibir &; prohibir &
...
**hollanda** [Textiles] Holland (cambric) *Hence:* hollandese
...
**horologio-bracialetto** *n* wrist watch
...
**hungaria** *n* Hungary
**hungaro¹ (húng-)** *n* Hungarian (= native of Nungary) *Hence:* Hungaria; hungare-hungaro² 
...
**hyacintho** *n* hyacinth (1. [Bot.]; 2. [Mineral.]; *also:* jacinth); hyacintho [Gr. Mythol.] Hyacinthus *Hence:* hyacinthin
...
**hydro·cephale** *adj* [Med.] hydrocephalous,
**hydrocephalic** *Hence:* hydrocephalia; hydrocephalo
...
### I
**igloo** [A] *n* igloo
**incantate** 1. *pp* of **incantar**; 2. *adj* delighted
**inclinate** 1. *pp* of **inclinar**; II. *adj* 1. inclined; 2. prone, tending
**incular** *v* [Colloq.] 1. to sodomize, to anally penetrate, to bugger, to fuck in the ass; 2. to scam, to rob, to fuck over (sb), to act maliciously behind sb's back, to set sb up, etc.
**inculate** *adj* [Colloq.] shitty, crappy
**inculate** *n* [Colloq.] faggot, effeminate male
**indebitate** 1. *pp* of **indebitar**; 2. *adj* indebted
**indie** *adj* Indian
**inducite** 1. *pp* of **inducer**; 2. *adj* induced
**informate** 1. *pp* of **informar**; II. *adj* 1. (well-)informed; educated, learned; 2. formed, shaped
**inricchite** 1. *pp* of **inricchir**; 2. *adj* enriched
**intransitive** *adj* [Gram.] intransitive
**inventate** 1. *pp* of **inventar**; 2. *adj* invented
**irrumar** *v* [Colloq.] to face-fuck (sb)
**irrumate** *n* [Colloq.] [Sex] s/he who penetrates in the mouth, s/he who is face-fucked
**irrumation** *n* [Colloq.] face-fucking, irrumation
**irrumator** *n* [Colloq.] [Sex] s/he who penetrates the mouth, s/he who fucks sb's face
**isto** *pron* this (= this thing, reason, or idea)
**iva** *past* of **ir** went
...
**jadificar** *v* to transform into, to make look like, to jade
...
**jesus (-sús)** *npr* Jesus *Hence:* jesuita & -jic- *see* jac-
...
**jockey** [A] *n* jockey
**joco** *n* 1. play, game (as in "the play of children," "the game of chess," etc.) [proposed] *n* **joco de cartas** card game; 2. playing, gaming, gambling; 3. game (= set of things needed to play a game); 4. [Mech.] play; 5. joke, jest; **joco de parolas** play on words *Hence:* jocose; joculo-jocular¹, jocular² &; jocar-jocator
...
**jubileo (-éo)** *n* jubilee (1. [Jewish Hist.] year of jubilee; 2. [R.C.Ch.] as in "extraordinary jubilee"; 3. celebration of the fiftieth anniversary of an event)
**jubilo (júbilo)** *n* exultant joy, jubilee *Hence:* jubilari; jubilar-jubilante, jubilation,
jubilator
...
**jugulo** *n* 1. collarbone; 2. throat; *also:* [Zoo].]
**jugulum** *Hence:* jugular¹; jugular²
**jujube** [F] *n* jujube
...
**lacte** *n* 🚧(#). [Colloq.] (vulgar) cum, sperm, semen
**lares** *npl* [Rom. Relig.] lares
**lascive** *adj* [Colloq.] horny, [Sex] easy, slutty, [Sex] hot
**levatori** *adj* elevatory
**libidinose** *adj* [Colloq.] turned on, horny, aroused, sprung, wet
**lubric** *adj* [Colloq.] hot, sexy
...
**millesimo (-illé-)** *n* thousandth (part)
...
**obverso** *n* obverse
**octantesimo (-té-)** *n* eightieth (part)
**octogesimo (-gé-)** *n* eightieth (part)
**operari** *adj* working, operative
**ore**, 🚧 **ore impur** [Colloq.] cocksucker
**OVNI** or **Objecto Volante Non Identificate** _n_ UFO, unidentified flying object
### P
...
**pagar** *v* 1. to pay (someone); 2. to pay, settle, discharge (a debt, fine, bill, etc.); 3. to pay for (sth) *Hence:* paga; pagamento; pagabile-impagabile; pagator; repagar-repagamento; superpagar- superpaga
...
**paisage (-aje)** *n* landscape, scenery *Hence:* paisagista
...
**palatio** *n* palace; palatio de justitia courthouse *Hence:* palatial; palatian-palatiano,
palatianismo; palatin &
**palato** *n* palate *Hence:* palatal-palatalisar-palatalisation; palatin
**pale**- *adj* [occurring in compounds] paleo-,
**pale**- (= ancient, early) *Hence:* paleographo etc.; paleolitho etc.; paleontologo etc.; paleozoic etc.
...
**palin** *adv* [occurring in compounds] palin-,
**palim**- (= again) *Hence:* palingenese etc.; palingenesis etc.; palinodia etc.; palindromo etc.; palimpsesto etc.
...
**papiro** *n* paper (as in "linen paper", "writing paper", etc.); **papiro moneta** paper money; **papiro autographic** transfer paper; **papiro de tornasol** litmus paper; **papiro hygienic** toilet
paper; **papiro siccante** blotting paper, blotter; **papiro de seta** tissue paper *Hence:* papirero; papireria; papiro-smerilio eto.; secapapiro etc.; cargapapiros etc.
...
**parcellamento** *n* division into (small) portions, parceling out; *also:* division into lots
**parcellar** *v* to divide into (small) portions, to parcel out; *also:* to divide into lots
...
**Paris** *npr* Paris
**parisian** *adj* Parisian
**parisiano** *n* Parisian
...
**parti·cipe (-tí-)** *adj* sharing, participant *Hence:* participio &: participar-participante,
...
**partir** *v* 1. to part, divide; 2. to depart, leave; **a partir de** reckoning from, as from, starting from (date/time) *Hence:* partibile-impartibile; partition, partitive; partitor; partite-multipartite etc., partito &, partita; compartir &; departir &; impartir &; repartir &; bipartir etc.
...
**passive** *adj/n* [Colloq.] [Sex] bottom (usu referring to anal sex)
...
**paternitate** *n* paternity, fatherhood -pathe [occurring in compounds] -path (1. suffering, sufferer; 2. advocate of or person practicing ...pathy) *Hence:* psychopathe etc.; allopathe etc.; homeopathe etc.
...
**paula** *nprf* Paula [paulatim] (-lá-) *adv* gradually, by degrees, little by little, a little at a time
**paulin** *adj* Pauline
...
**pedito (pé-)** *n* (action of) breaking wind, farting, tooting, pooting, letting off gas, passing gas
...
**pegaso (pé-)** *npr* [Gr. Mythol.] Pegasus; montar super Pegaso to mount one's Pegasus -**peia (-péya)** [occurring in compounds] -peia, -poeia *Hence:* epopeia etc.; onomatopeia etc.;
pharmacopeia etc.
...
**pekingese** *adj* Pekingese, of Beijing
**pekingese** *n* Pekingese (1. native of Peking, Beijinger; 2. Pekingese dialect; 3. pekingese dog)
...
**penetrar** *v* to penetrate; **penetrar se de (un facto)** to become imbued with (a fact) *Hence:* penetrabile-penetrabilitate, impenetrabile-impenetrabilitate; penetration;
penetrative; penetrate; compenetrar &
...
**penitential** *adj* penitential (= pertaining to ecclesiastical penance) penitential *n* [Eccl.]
penitential (book)
...
**penny** *pl* **pence** penny; (*pl*) pence; pennies [A] *n* [Monet.] penny
...
**perci·forme** *adj* [Zool.] perciform (1. resembling a perch; 2. of or pertaining to the
perciformes)
...
**perco·morphe** *adj* [Zool.] percomorph,
**percomorphous** *Hence:* percomorpho
...
**perder** *v* 1. to ruin, undo; 2. to lose; **perder se** to lose one's way, go astray; 3. to miss; **perder (un traino)** to miss (a train) *Hence:* perdibile-imperdibile; perdition; perdita
**perdibile** *adj* losable
**perdice** *n* partridge
**perdita (pér-)** *n*; perditas [Mil.] casualties, losses
...
**perfic- [-fic-/-fect-]** *v* [occurring in derivatives] *Hence:* perfectibile-perfectibilitate, imperfectibile-imperfectibilitate; perfection-perfectionar-perfectionamento, imperfection;
perfective; perfecte-imperfecte-imperfecto,perfecto-plusquamperfecto etc.
...
**persecution** *n* 1. pursuit (= action of following after or chasing); 2. persecution; **mania de persecution** persecution mania, persecution complex
...
**persona** *n* person; *also:* character (as in "character in a play"); **in persona** in person;
**persona juridic** juridical person *Hence:* personage; personal-personalitate,
...
**petra** *n* stone (1. rock; 2. [Med.] calculus); **petra de tocca** touchstone; **petra pumice** pumice stone; **petra angular** cornerstone; **petra philosophal** philosopher's stone; **petra de altar** altar stone; **petra infernal** [Med.] silver nitrate *Hence:* petrario; petreria; petrific; petrose; petrificar-petrification; petrographo etc.; petroleo etc.; salpetra etc. -petrar *v* [occurring in compounds] *Hence:* impetrar &; perpetrar &
...
**phase** *n* phase; *also:* [Astron., Biol., Phys., etc.] -phasia (-ía) [occurring in compounds] -phasia *Hence:* aphasia-aphasic-aphasico; dysphasia 
-**phem**- *n* [occurring in compounds] -**phem**- (1. voice; 2. report, rumor) *Hence:* eupheme etc.
**phen**- [occurring in derivativcs and compounds] *Hence:* phenol; phenylo-phenylamino etc.;
phenic
...
**philatelista** *n* philatelist -phile *adj* [occurring in compounds] -phile (as in "bibliophile", loving books) *Hence:* anglophile etc.; bibliophile etc.; hemophile etc.; spermophilo etc.; philo-philanthropo etc., philharmonia etc., philosopho etc., Philadelphia etc.
...
**phono·metro (-nó-)** *n* phonometer *Hence:* phonometria -phore *adj* [occurring in compounds] -phore, -phorous (= carrying; carrier, bearer) *Hence:* acanthophore etc.; rheophoro etc.
...
**photo·grapho (-ógrafo)** *n* photographer *Hence:* photographia-astrophotographia etc., chromophotographia etc., microphotographia etc., telephotographia etc.; photographic;
photographar
...
**photo·typo (-ótipo)** *n* [Print.] phototype *Hence:* phototypia; phototypic; phototypographia etc.
...
**phrygio** *n* Phrygian -phthong- *n* [occurring in compounds] -phthong (= voice; sound) *Hence:* diphthonge etc.; triphthongo etc.
**phthisis (-ísis)** *n* phthisis
...
**pietate** *n* 1. [Relig.] piety; 2. affectionate devotion; 3. pity (= compassion); **haber pietate de** to pity or have pity on; **facer pietate a un persona** to arouse sb's pity or compasssion
**pietismo** *n* Pietism
**pietista** *n* Pietist
...
**pipetta** *n* pipette
**pipi (pipí)** *n* [Colloq.] (informal, not vulgar) pee **facer pipi** to pee, to wee *see* **urina**
**pipina** *n* [Colloq.] (children's language) peepee (= vagina)
**pipino** *n* [Colloq.] (children's language) peepee (= penis)
**pipion** *n* dove, pigeon
**piqué** [F] *n* piqué (= ribbed cotton fabric)
**pira** *n* pear (= fruit of the pear tree) *Hence:* piriero -pirar *see* spirar
...
**pissa** *n* [Colloq.] (vulgar) piss, pee
**pissar** *v* [Colloq.] (vulgar) to piss, to pee, to wee **pissar sur/supra** to disrespect, to hate, to piss on sth, to spit on sth **io pissa sur ille/io le pissa supra** (fig.) I hate him and feel no respect for him **pissar se** 1. to piss os, to wet os, to soil os; 2. (fig.) to be scared shitless 3. (fig.) to die of laughter, to piss os laughing **illes se ha pissate per un septimana postea** they kept on being scared/laughed for a week after what happened
**pissata** *n* [Colloq.] pissing (action), urination
...
**pixel** _n_ pixel **rate de pixel** pixel art, 8-bit art  
...
**placer** *v* to please; **placer a un persona** to please sb; **si il vos place** (if you) please *Hence:* placide &; placente; complacer &; displacer-displacente-displacentia
**placer¹** *n* pleasure
...
**plaga** *n* 1. wound; sore; 2. plague (= affliction, calamity); **poner le digito super le plaga** to put one's finger on the sore spot, (*fig.*) to hit/touch/strike a nerve, to strike a cord *Hence:* plagar
...
**plastico** *n* plastic, plastics (as in "plastic or plastics is a widely used material"); plasticos
plastics (as in "plastics are widely used materials")
...
**platy**- *adj* [occurring in compounds] platy-,
**plat**- (= flat) *Hence:* phthelminthe etc.; platycephale etc.
...
**plausibilitate** *n* plausibility, plausibleness -ple *adj* [occurring in compounds] *Hence:* multiple etc.; centuple etc.; duple etc.; simple etc.; triple etc. 
...
**pleonasto** *n* [Mineral.] pleonaste, ceylonite -pler *v* [occurring in compounds] *Hence:* compler &; depler &; expler &; impler &; repler &; suppler &
...
**plicatura** *n* plication, plicature -plice *adj* [occurring in derivatives and compounds] *Hence:* duplice etc.; multiplice etc.; simplice etc.; quadruplicar etc.
**plio·cen** *adj* [Geol.] Pliocene *Hence:* plioceno
**plioceno** *n* [Geol.] Pliocene
**plorar** *v* to cry, weep *Hence:* deplorar &; implorar & [plu] *adv* (= plus) *Hence:* plutosto etc.
**pluche** [F] *n* plush
...
**pluri·locular** *adj* [Bot., Zool.] plurilocular [plurimel (plú-) *adj* 1. much; 2. many [plurimo] **(plú-)** *adv* 1. much, exceedingly; 2. for the most part, commonly, usually
**pluri·nominal** *adj* plurinominal
**plus** 1. more; 2. plus; **plus belle (que)** more beautiful (than); **plus grande (que)** greater, bigger (than); **plus de (vinti annos)** more than, over, above (twenty years); **le plus belle** the most beautiful (one); **le plus grande** the greatest, biggest; **(le) plus** (the) most (as in "what pleased me (the) most"); **de plus** furthermore, besides; **de plus in plus** more and more; in plus furthermore, in addition, *also*; **(tres) plus (quatro)** (three) plus (four); **al plus** at (the) best; **plus o minus** more or less; **non ... plus** no more, not any more (1. nothing more; 2. no longer); **plus (de) (moneta, etc.)** more (money, etc.) *Hence:* plus-valor etc.; plusquamperfecto etc.
...
**pluton** *npr* [Class. Mythol.; Astron.] Pluto *Hence:* plutonismo; plutonista; plutonic;
plutonie-plutonium
...
**plutonomic** *n* plutonomic [plu·tosto] *adv* (= plus tosto)
...
**poema** *n* poem
**poesia (-ía)** *n* poetry
**poeta** *n* poet *Hence:* poetastro; poetessa; poetic; poetica;
poetisar
...
**polaritate** *n* polarity -pole *n* [occurring in derivatives and compounds] -polis (= city) *Hence:* -polita &; acropole etc.; metropole etc.; Constantinopole etc.; necropole etc.; Neapole etc.; Tripole etc.
**Policinella** *npr* Polichinelle
**polea (-éa)** *n* pulley
...
**polir** *v* to polish (1. to make smooth and shiny; 2. to refine) *Hence:* polimento; politor; politura; polite &; dispolir -polis *n* [occurring in compounds] *Hence:* Indianapolis etc.
...
**ponte** *n* I. bridge (1. "bridge over a river, etc"; 2. [Dent]; 3. "bridge of a musical instrument"); II. [Naut] deck; **ponte del asinos** [Math] asses' bridge, pons asinorum; **jectar un ponte** to throw a bridge; **capite del ponte** [Mil] bridgehead;
**ponte levatori** drawbridge *Hence:* pontero; ponton &; pontar
...
**popular** *v* to people,  opulate; *also:* to stock (with animals or plants)
...
**populose** *adj* populous [por] *prep* for (1. not against; 2. in place of, in exchange or return for; **por (+inf)** in order to; **partir por (Paris)** to leave or set out for (Paris); (= **pro**) *Hence:* porque etc
...
**porphyroide** *n* [Petrography] porphyroid [por·que] *conj*/*adv* 1. why (= for what reason); 2. because (= **proque**)
...
**postponer [-pon-/-posit-]** *v* to postpone *Hence:* postponimento; postposition;
postpositive
...
**practic (prác-)** *adj* practical (1. not theoretical; 2. as in "a practical individual"; 3. adapted for a required purpose) *Hence:* practicar-practicante, practicabile-
practicabilitate, impracticabile- impracticabilitate; practica
...
**predeterminar** *v* to predetermine (1. to determine beforehand; 2. [Theol]) **predetermination** *n* predetermination (1. act of predetermining; 2. [Theol])
...
**prender [prend-/prens-/pris-]** *v* 1. to take hold of, catch, seize, take ; 2. [Colloq.] (*Sex*) to take it, to be a bottom (usu referring to anal sex) **illa/ille qui lo prende** bottom, s/he who takes [the penis]*Hence:* prendibile-imprendibile- imprendibilitate; prension; prisa; prenditor; apprender &; comprender &; interprender &; reprender &; surprender &
...
**presentar** *v* to present; to introduce; **presentar le armas** to present arms; **presentar (un persona a un altere)** to introduce (one person to another) *Hence:* presentabile; presentation; presentator; representar &
...
**presentir** *v* to have a presentiment *Hence:* presentimento [presertim] (-sér-) *adv* especially, particularly, chiefly
...
**pretention** *n* pretension, pretense (1. claim; 2. pretentiousness)
**pretentiose** *adj* 1. making pretensions or laying claims; 2. pretentious, presumptuous, conceited
**preter (pré-)** I. *adv* past, beyond; II. *prep* 1. past, along(side of), beyond; 2. except, excepting; 3. in addition to *Hence:* [preterea] etc [preter·ea] (-tér-) *adv* 1. besides, moreover; 2. henceforth, hereafter
...
**prision** *n* prison; **mitter in prision** to put in
**prison** *Hence:* prisionero; imprisionar- imprisionamento
**prisionero** *n* prisoner
**prisma [-ma/-mat-]** *n* prism *Hence:* prismatic; hemiprisma etc
**prismat**- *see* **prisma**
**prismatic** *adj* prismatic
**priv**- *adj* [occurring in derivatives] *Hence:* privar-privation, privative, private-
privata; privilegio etc
**privar** *v* to deprive
**privata** *n* privy, latrine
**private** 1. *pp* of **privar**; 2. *adj* private; **in privato** in private; **schola private** private school
**privatessa** [proposed] _n_ privacy
...
**pro**- *prefixo* **pro**- (1. forward, forth; 2. before in time or place; 3. deputy, agent of; 4. in favor of, on the side of ) *Hence:* producer etc; proponer etc; proconsule etc; prosemita etc
...
**probabile** *adj* 1. provable; 2. probable *Hence:* probabilismo; probabilista;
probabilitate; improbabile-improbabilitate
...
**procreator** *n* procreator [procul] (pró-) *adv* far off, far away, at a distance
**procurar** *v* to procure (= to secure after effort); **procurar se un cosa** to procure sth *Hence:* procuration; procurator; procuratorio
...
**prolongar** *v* to prolong; *also:* to lengthen *Hence:* prolongamento; prolongabile;
prolongation; prolongator
...
**promissori** *adj* promissory (= containing a
promise)
...
**propaganda** *n* propaganda *Hence:* propagandista-propagandistic;
propagandisar
...
**proparoxytone** *adj* [Phonet] proparoxytone [prope] adv/prep near, close, at hand
**propeller [-pell-/-puls-]** *v* to propel *Hence:* propulsion; propulsor
**propender [-pend-/-pens-]** *v* to tend, have an inclination (towards sth) *Hence:* propension; propense
...
**proportionate** I. *pp* of **proportionar**; II. *adj* 1. proportioned (= formed, fashioned); 2. proportionate; **ben proportionate** well-proportioned; **proportionate a** proportionate to
...
**proposito (-pó-**) *n* purpose (1. aim; 2. subject under discussion); **(dicer un cosa) a proposito** (to say sth) to the purpose, apropos, to the point; **a omne proposito** at every turn; **a proposito!** by the way! incidentally; **foras de proposito** ill-timed, irrelevant, beside the mark; **a proposito de** with regard to, apropos of
...
**prorogar** *v* to prorogue, prorogate (= to
 ostpone, adjourn) *Hence:* prorogation
...
**prospere,** *n* [Colloq.] 1. (masc) hung boy, well-endowed man, man with big penis; 2. (fem) busty girl, well-endowed woman, woman with big breasts
...
**protégé** [F] *n* protégé
**proteger** [-teg-/-tect-] *v* to protect *Hence:* protective; protection-protectionismo,
protectionista; protector-protectorato; protectrice
...
**prova** *n* proof (1. evidence sufficient to establish a fact; 2. test, trial; 3. [Print, Phot, etc]); 4. -proof (as in "waterproof"); **poner al prova** to put to the proof; **a prova de bomba** bombproof; **prova prime** galley proof; **leger le provas** to proofread; **lectura del provas** proofreading; **lector del provas** proofreader
...
**proverbio** *n* proverb, byword; le Proverbios the
**proverbs** *Hence:* proverbial
...
**proxime (próx-)** *adj* 1. very near, close; 2. next (as in "next week"); **causa proxime** [Philos] proximate cause; **proximo** *n* neighbor, fellow being *Hence:* proximitate; approximar &
**proximemente** *adv* shortly, soon
**proximitate** *n* proximity; **proximitate del sanguine** proximity of blood; **in le proximitate de** in the proximity or vicinity of, near
**proximo (próx-)** *n* neighbor, fellow being
...
**pseud**- [occurring in compounds] pseud-,
**pseudo**- (= false, falsely) *Hence:* pseudesthesia etc; pseudopropheta etc; pseudopodio etc; pseudoclassic etc
...
**pubere** *adj* who has arrived at puberty,
**pubescent** *Hence:* pubertate; impubere
**pubertate** *n* puberty
...
**pulicose** *adj* infested with fleas, pulicous, flea-ridden
...
**pulmon** *n* lung; **a plen pulmones** at the top of one's voice, at the top of one's lungs *Hence:* pulmonia; pulmonar; pulmonaria; pulmonate; pulmonifere
...
**pulvere** *n* I. dust; II. powder (1. pulverized substance; 2. [Specif: Pharm, Cosmetics]; 3. gunpowder); **jectar pulvere in le oculos de un persona** to throw dust in someone's eyes; **reducer in pulvere** to reduce to powder; **ille non habe inventate le pulvere** he won't set the world (or Thames) on fire *Hence:* pulverose; pulverulente-pulverulentia; pulverar-dispulverar; pulverisar-pulverisabile,
**pulverisation**, pulverisator
...
**pungente** I. *ppr* of **punger**; II. *adj* 1. pungent; 2.
**poignant** *Hence:* pungentia
...
**pupu (pupú)** *n* [Colloq.] (children's language) poopoo, bum, booty
...
**puta** or **putana** *n* [Colloq.] whore, slut, bitch **de puta, puta de** (vulgarizing) shitty, fuck!, fucking, damn **filio de puta** son of a bitch **filia de puta** (of a female) son of a bitch (literally "daughter of a whore") **iste puta de cosa** this fucking thing
...
**puter** *v* to stink
**puto** *n* [Colloq.] male prostitute, tart
...
**putsch** [G] *n* putsch
**pyjama** *n* pajamas
**pyl**- *n* [occurring in derivatives and compounds]
**pyl-** (= gate) *Hence:* pylon; propyleo; pyloro etc; Thermopylas etc
**pylon** *n* [Arch] pylon
**pyloric** *adj* pyloric
...
**rabiar** *v* 1. to rage, be in a rage, to be hopping mad, to be livid; 2. to go mad, develop rabies, to go crazy
...
**rase** 1. *pp* of **rader**; 2. *adj* scraped
**rasorio** *n* razor
...
**recollection** *n* recollection (= recollecting os in prayer etc.)
**recolliger [-lig-/-lect-]** *v* 1. to collect (= to make a collection of); 2. to gather harvest; 3. to take in, shelter; **recolliger se** to recollect os *Hence:* recolligimento recollection
...
**recordar** *v* to remind; **recordar un cosa a un persona** to remind sb of sth
...
**recuperar** *v* to recover (1. to get back again; 2. to recoup, make up for); rec**uperar se (de un perdita)** to recoup os (for a loss), recuperate (from a loss) *Hence:* recuperabile-irrecuperabile; recuperation: recuperator
...
**refrescar** *v* 1. to cool (= to make or become cool in temperature); 2. to refresh, renew; **refrescar se** to refresh os (by means of refreshments, rest, etc.); **refrescar le memoria de un persona** to refresh someone's memory *Hence:* refrescamento
...
**refrigidar** *v* 1. to cool (sth), chill; 2. to cool off, become cold, [Colloq.] to chill, to chill out
...
**regurgitar** *v* to regurgitate, to throw (sth) up; *also*: to vomit (sth), to spew *Hence:* regurgitation
...
**remaritar** *v* to remarry (sb) (= to unite again in wedlock); **remaritar se** to remarry (= to get married again)
...
**remitter [-mitt-/-miss-]** *v* I. to put back, restore; II. to remit (1. to transmit, send; 2. to forgive; 3. to abate, become less); III. to postpone, remit; **remitter se** a to rely on, to count on *Hence:* remissibile-remissibilitate, irremissibile- irremissibilitate; remission; remissa
...
**reptile** *adj* reptile *n* reptile
**republica (-pú-)** *n* 1. commonwealth, state; 2.
**republic** *Hence:* republican-republicanismo, republicanisar, republicano
...
**reputate** 1. *pp* of **reputar**; 2. *adj* reputed
...
**residente** 1. *prp* of **resider**; 2. *adj* residing, resident 
...
**resignar** *v* to resign (an office, right, etc.); **resignar se (a)** to resign os (to) *Hence:* resignation
...
**resortir** *v* to go or come out again, to go/come back out
...
**restante** 1. *ppr* of **restar**; 2. *adj* residuous, remanent
...
**resto** *n* rest, remainder; specif.: [Arith.] remainder; **restos** remains; leftovers, what's left
**restrict-** *see* **restringer**
**restriction** *n* restriction; restriction mental mental reservation
**restrictive** *adj* restrictive
**restringer** [-string-/-strict-] 1. *v* to restrict, restrain; **restringer se (a)** to confine os (to) *Hence:* restriction; restictive; restringitor
...
**retardate** 1. *pp* of **retardar**; 2. *adj* retarded, delayed
...
**rete** *n* 1. net (as in "fish net," "hair net," etc.); 2. network (as in "a network of railroads"); 3. [Comp.] **le rete** the Web, the Internet *Hence:* reticulo &; retiario; retina &
**retemperar** *v* [Metal.] to retemper
**retenaculo** *n* [Bot.] retenaculum
**retener** [-ten-/-tent-] *v* I. to keep, hold (back), detain, withhold, hinder, etc.; II. to retain (1. to preserve; 2. to reserve; 3. to remember); III. to restrain, curb, keep from, etc.; **retener se** to check os *Hence:* retenaculo; retenibile; retention; retentive-retentivitate; retentor
...
**retic-** [occurring in derivatives] *Hence:* reticente reticentia
...
**reticulo** *n* I. reticulum (1. net, netlike structure, membrane, etc.; 2. [Zool.] second stomach of a ruminant); II. reticule (= ladies' handbag); III. [Opt.] reticle; *also:* lattice, etc.; (aiming) reticule *Hence:* reticular¹; reticulate; reticular²- reticulation
...
**retirar** *v* to withdraw, take away; **retirar se** I. to retire, to retreat (1. to seek seclusion; 2. "to retire from business"); II. [Mil.] to retreat *Hence:* retiro; retirada; retiramento
...
**retro** *adv* back (1. backwards; 2. ago *cf* **il ha**; 3. as in "to give back"); **a retro** backwards *Hence:* arretrar-arretrate-arretrato 
...
**reverso** *n* I. reverse (1. opposite, contrary; 2. back, opposite side; 3. adverse change of fortune); II. revers; *also*: lapel; III. cuff (of trousers, boots, etc.); **le reverso del medalia** the reverse of the medal; **obverso e reverso** obverse and reverse; **le reverso del libro** the back cover (of the book)
**reverter [-vert-/-vers-]** *v* to turn, to turn round, to turn around, reverse *Hence:* reversibile-reversibilitate; reversion; reverse-reverso
...
**revider [-vid-/-vis-/-vist-]** *v* 1. to see (sb or sth) again; 2. to review (= to inspect or examine again); *also*: to revise *Hence:* revision-revisionista; revisor; revista
...
**reviviscer** *v* to revive, to come to life again, to come back to life *Hence:* reviviscente-reviviscentia
...
**rhyncho-** *n* [occurring in compounds]
**rhyncho-, -rhynch-** (= snout; beak) *Hence:* ornithorhynche etc. ...
...
**ricino** *n* castor-oil plant, ricinus
...
**rimar** *v* 1. to make rhymes or verses; 2. to
rhyme (= to accord in rhyme)
...
**Röntgen, Wilhelm Konrad** *npr* [1845-1923; German physicist]; **radios Röntgen** Roentgen rays, x-rays *cf* **radio X** *Hence:* röntgen; röntgenogramma etc.;
röntgenologia etc.
...
**-rrhagia** *see* -**rhagia**
**-rrhea (-réa)** [occurring in compounds] **-rrhoea**,
**-rrhea** (= flow; discharge) *Hence:* gonorrhea etc.; rhinorrhea etc.
**-rrhin** *see* **rhin-**
**-rrhiza** *see* **rhiz-**
...
**rude** *adj* rude (1. roughly made or done, without
finish or polish; 2. impolite, not courteous) *Hence:* erudir &
...
**rumper [rump-/rupt-]** *v* to break (1. to make come apart or to pieces; 2. to put an end to; 3. to come apart or to pieces); **rumper se le capite** to rack one's brain(s); **rumper con un persona** to break with someone; **rumper le silentio** to break silence *Hence:* rumpimento; rumpente; ruptura; rupte-bancarupta etc.; abrump- &; corrumper &; disrumper &; erumper &; interrumper &; irrumper &; rumpeglacie etc.; rumpenuces etc.
...
**rustic** *adj* rustic (1. pertaining to the country; 2.
rough, unrefined) *Hence:* rusticitate; rusticar-rustication; rustico 
...
**rutilo (rú)** *n* [Mineral.] rutilenar *v* to ruminate
**rumination** *n* rumination
**rumine** *n* rumen (= first stomach of ruminants) *Hence:* rummar-ruminante; rumination
**rumor** *n* 1. rumor, report; 2. hum, murmur; din, hubbub, etc. *Hence:* rumorose; rumorar
**rumorar** *v* 1. to rumor; 2. to create a hubbub
...
**rupt-** *see* **rumper**
**rupte** *adj* broken
**ruptura** *n* rupture, breaking; ruptura de pneu
[Motoring] blowout
**rural** *adj* rural *Hence:* ruralisar
**ruralisar** *v* to ruralize (= to make rural)
**russe** *adj* Russian
...
**tenitor** *n* keeper
**tertio** *n* third (part)
**tetta** *n* [Colloq.] tit, titty **tettas** tits, titties, rack
**transactar** *v* to transact
**trentesimo (-té-)** *n* thirtieth (part)
**trillionesimo (-né-)** *n* trillionth (part)
### U
**ubere** *n* udder 
...
**ulcerose** *adj* ulcerous (1. having the nature of an ulcer; 2. ulcerated) [ulle] adj/pron any, anyone *Hence:* nulle &
...
**ultraviolette** *adj* ultraviolet; radios
**ultraviolette** ultraviolet rays
**uluco (ú-)** *n* owl
...
ur- *v* [occurring in derivatives] *Hence:* ureter &; urethra & -ura *suffixo substantive* [used with the second stem of verbs in -er and -ir] -ure (= action or result of ...ing) *Hence:* mixtura etc.; pictura etc.; fissura etc.; cultura etc.; copertura etc.
...
**urger** *v* to urge, be insistent or pressing; also: to be urgent *Hence:* urgente-urgentia -urgo [occurring in compounds] -urge (= worker) *Hence:* chirurgo etc.; metallurgo etc.; thaumaturgo etc.; siderurgia etc. -uria [occurring in compounds]
...
**ursin** *adj* ursine
**urso** *n* bear; **urso polar/blanc** polar bear *Hence:* urson; ursin; ursa
...
**usurpator** *n* usurper
**usurpatori** *adj* usurpatory [ut] *adv* as, how, in order that, to the end that, just as; ut ... ita ... the ... the ..., as ... so ... *Hence:* sicut etc.
**ut** *n* [Mus.] (the note) C
...
**utopista** *n* utopian [utroque] *indef pron* either or both of two 
...
### V
**vegan** _adj_ vegan  
**veganismo** _n_ Veganism
**ventura** *n* 1. fortune, luck; 2. risk, hazard
**vernissate** 1. *pp* of **vernissar**; 2. *adj* varnished
**vidite** 1. *pp* of **vider**; 2. *adj* seen
**Vietnam** _n_ Vietnam  
**vietnamese** _n_ Vietnamese (language)
**vindication** *n* vindication
**vintesimo (-té-)** *n* twentieth (part)
**virga** *n* [Colloq.] 1. cock, dick, pecker, penis; 2. the fuck **que virga tu dice?** what the fuck are you talking about?
**volante** 1. *ppr* of **volar**; 2. *adj* flying
### W
**wadi (-dí)** [Ar.] *n* wadi
**wafla** *n* waffle
...
**yug**- *n* [occurring in geographical compounds]
**yugo**-, **jugo**- (=*south*) *Hence*: yugoslave etc.
...
**zona** *n* zone; **le zona torride** the Torrid Zone; **zona temperate** Temperate Zone; **zona frigide/glacial** Frigid Zone *Hence:* zonal-bizonal etc.; zonar
**zonal** *adj* zonal
**zonar** *v* to zone
